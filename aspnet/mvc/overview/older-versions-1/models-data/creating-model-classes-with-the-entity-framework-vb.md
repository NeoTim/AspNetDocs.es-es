...
title: Creación de clases de modelo con Entity Framework (VB) Microsoft Docs
...
El \_campo db se utiliza dentro de la acción Index() para recuperar los registros de la tabla de base de datos Movies. La \_expresión db. MovieSet representa todos los registros de la tabla de base de datos Movies. El método ToList() se utiliza para convertir el conjunto de películas en una colección genérica de objetos Movie: List( Of Movie).
...
**Listado 3 – Controllers-HomeController.vb (Add methods)**
