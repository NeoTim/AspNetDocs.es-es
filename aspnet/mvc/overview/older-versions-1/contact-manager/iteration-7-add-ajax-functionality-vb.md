...
title: 'Iteración #7: agregar la funcionalidad de Ajax (VB) Microsoft Docs'
...
ms.locfileid: "81542305"
---
# <a name="iteration-7--add-ajax-functionality-vb"></a>Iteración n.º 7: Agregar funcionalidad de Ajax (VB)
...
[![Actualización de solo contactos](iteration-7-add-ajax-functionality-vb/_static/image1.jpg)](iteration-7-add-ajax-functionality-vb/_static/image1.png)

**Figura 01**: Actualización de solo contactos[(Haga clic para ver la imagen de tamaño completo)](iteration-7-add-ajax-functionality-vb/_static/image2.png)
...
**Listado 3 - Controllers-ContactController.vb (método Index)**
...
**Figura 02**: La página de confirmación de eliminación[(Haga clic para ver la imagen de tamaño completo)](iteration-7-add-ajax-functionality-vb/_static/image4.png)
