...
title: Validación con los validadores de anotaciones de datos (C-) Microsoft Docs
...
**Figura 1**: Adición de una referencia al enlazador de modelos de anotaciones de datos ([Haga clic para ver la imagen de tamaño completo](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
**Figura 6**: Uso de validadores con Entity Framework ( Haga clic para ver la[imagen de tamaño completo](validation-with-the-data-annotation-validators-cs/_static/image14.png))
