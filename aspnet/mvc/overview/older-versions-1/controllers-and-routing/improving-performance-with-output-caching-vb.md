...
title: Mejorar el rendimiento con el almacenamiento en caché de salida (VB) Microsoft Docs
...
Observe que &lt;el&gt; atributo OutputCache del listado 4 incluye una propiedad Location establecida en el valor OutputCacheLocation.Client. El &lt;outputCache&gt; atributo también incluye un NoStore propiedad. La propiedad NoStore se utiliza para informar a los servidores proxy y exploradores de que no deben almacenar una copia permanente del contenido almacenado en caché.
...
El controlador en el listado 7 ilustra cómo puede aplicar el &lt;perfil&gt; Cache1Hour a una acción de controlador con el OutputCache atributo.
...
El almacenamiento en caché de resultados proporciona un método muy fácil de mejorar drásticamente el rendimiento de las aplicaciones MVC de ASP.NET. En este tutorial, ha aprendido &lt;a&gt; usar el atributo OutputCache para almacenar en caché la salida de las acciones del controlador. También aprendió a modificar &lt;las&gt; propiedades del atributo OutputCache, como las propiedades Duration y VaryByParam, para modificar cómo se almacena en caché el contenido. Por último, aprendió a definir perfiles de caché en el archivo de configuración web.
