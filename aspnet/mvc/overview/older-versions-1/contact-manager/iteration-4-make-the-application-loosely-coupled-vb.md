...
---
# <a name="iteration-4--make-the-application-loosely-coupled-vb"></a>Iteración n.º 4: Hacer que la aplicación tenga un acoplamiento flexible (VB)
...
**Listado 1 - Modelos-IContactManagerRepository.vb**
...
**Listado 2 - Modelos-EntityContactManagerRepository.vb**
...
**Listado 4 - Modelos-ContactManagerService.vb**
...
**Listado 7 - Modelos-Validation-ModelStateWrapper.vb**

[!code-vb[Main](iteration-4-make-the-application-loosely-coupled-vb/samples/sample7.vb)]

**Listado 8 - Modelos-Validation-IValidationDictionary.vb**
